                    ...
                    <div className="space-y-5">
                        ...
                        {pendingChanges && (
                            <div className="rounded-none border border-amber-200 bg-amber-50 p-4">
                                <div className="flex flex-wrap items-start justify-between gap-3">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            className="rounded-none bg-white px-3 py-1.5 text-xs font-semibold text-rose-700 ring-1 ring-rose-200 hover:bg-rose-50 disabled:opacity-60"
                                        >
                                        ...
                                        <button
                                            ...
                                            disabled={isDecidingPending}
                                            className="rounded-none bg-emerald-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-emerald-700 disabled:opacity-60"
                                        >
                                ...
                                <div className="mt-3 grid gap-2 md:grid-cols-3">
                                    <div className="rounded-none bg-white px-3 py-2 ring-1 ring-amber-200">
                                    ...
                                    <div className="rounded-none bg-white px-3 py-2 ring-1 ring-amber-200 md:col-span-2">
                                ...
                                {pendingChanges.proposedProfilePic && (
                                    <div className="mt-3">
                                        ...
                                        <img
                                            ...
                                            className="mt-1 h-20 w-20 rounded-none object-cover ring-1 ring-amber-200"
                                        />
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="flex flex-col gap-4 md:flex-row md:items-start">
                            <img
                                ...
                                className="h-28 w-28 rounded-none object-cover ring-1 ring-gray-200"
                            />
                        ...
                        <label className="block text-sm font-medium text-gray-700">
                            ...
                            <input
                                ...
                                className="mt-1 w-full rounded-none border border-gray-200 px-4 py-2 text-sm"
                            />
                        </label>
                        ...
                        <label className="block text-sm font-medium text-gray-700">
                            ...
                            <input
                                ...
                                value={artist.email}
                                readOnly
                                className="mt-1 w-full rounded-none border border-gray-200 bg-gray-50 px-4 py-2 text-sm text-gray-500"
                            />
                        </label>
                        ...
                        <div className="flex justify-end">
                            <button
                                ...
                                disabled={isSaving}
                                className="rounded-none bg-black px-5 py-2 text-sm font-semibold text-white hover:bg-gray-900 disabled:opacity-60"
                            >
                        ...
                        <div className="rounded-none border border-gray-200 bg-gray-50 p-5">
                            ...
                            <textarea
                                ...
                                className="mt-4 w-full rounded-none border border-gray-200 bg-white px-4 py-3 text-sm text-zinc-800"
                            />
                            ...
                            <div className="mt-4 space-y-3">
                                {feedbackItems.length === 0 ? (
                                    <div className="rounded-none border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-600">
                                        Nog geen privé feedback verstuurd.
                                    </div>
                                ) : (
                                    feedbackItems.map((item) => (
                                        <div key={item.id} className="rounded-none border border-gray-200 bg-white px-4 py-3 shadow-sm">
